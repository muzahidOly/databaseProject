...
<body>
    ...
    <section>
        <h2>Bad Client Information</h2>
		<p>List of all the clients that have never paid any bill after it is due. Suppose the bill is
		due one week after it is generated.</p>
        <c:choose>
