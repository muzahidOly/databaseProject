...
<body>
    ...
    <section>
        <h2>Good CLient Information</h2>
		<p>List all the clients that have paid their bills right after the bills are generated,meaning they paid the bill within 24 hours when the bill is generated.</p>
        <c:choose>
