...
<body>
    ...
    <section>
        <h2>Overdue Client Information</h2>
		<p>List all the bills that have not been paid after one week the bill is generated.</p>
        <c:choose>
